...
//        val senderId = auth.currentUser!!.uid
    ...
    override fun getMessages(senderId: String, receiverId: String) = callbackFlow {
    ...
    override fun getSenders() = flow {
        ...
        try {
            val reference = database.getReference(CHAT_REF).child("UserChats").child(auth.currentUser!!.uid)
                .get()
                .await()
